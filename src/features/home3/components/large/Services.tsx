...
import { Gradient } from "../../design/HeroDesign";
import Heading from "../medium/Heading";
import Generating, {
  PhotoChatMessage,
  VideoBar,
  VideoChatMessage,
} from "../../design/ServicesDesign";

import servicesData from "../../data/services.json";

const Services = () => {
  const [gamerstagServicesIcons, setGamerstagServicesIcons] = useState<
    string[]
  >([]);
  const [gamerstagServices, setGamerstagServices] = useState<string[]>([]);

  useEffect(() => {
    const icons = servicesData[0]?.gamerstagServicesIcons || [];
    const services = servicesData[1]?.gamerstagServices || [];
    setGamerstagServicesIcons(icons);
    setGamerstagServices(services);
  }, []);
  ...
  return (
    <Section id="how-to-use">
      <div className="container">
        ...
        <div className="relative font-extrabold text-sky-200">
          <div className="relative z-1 mb-5 flex h-[39rem] items-center overflow-hidden rounded-3xl border border-n-1/10 p-8 lg:p-20 xl:h-[46rem]">
            <div className="pointer-events-none absolute left-0 top-0 h-full w-full md:w-3/5 xl:w-auto">
              <Image
                ...
                alt="Smartest AI"
                height={730}
                src={"/home3-assets/svgs/services/service-1.png"}
              />
            </div>
            ...
            <div className="relative z-1 ml-auto max-w-[17rem]">
              ...
              <ul className="body-2">
                {gamerstagServices.map((item, index) => (
                  <li
                    key={index}
                  ...
                  >
                    <Image
                      ...
                      width={24}
                      height={24}
                      src={"/home3-assets/svgs/check.svg"}
                    />
          ...
          <div className="relative z-1 grid gap-5 lg:grid-cols-2">
            <div className="relative min-h-[39rem] overflow-hidden rounded-3xl border border-n-1/10">
              <div className="absolute inset-0">
                <Image
                  src={"/home3-assets/svgs/services/service-2.png"}
            ...
            <div className="overflow-hidden rounded-3xl bg-n-7 p-4 lg:min-h-[46rem]">
              <div className="px-4 py-12 xl:px-8">
                ...
                <ul className="flex items-center justify-between">
                  {gamerstagServicesIcons.map((item, index) => (
                    <li
                      key={index}
              ...
              <div className="relative h-[20rem] overflow-hidden rounded-xl bg-n-8 md:h-[25rem]">
                <Image
                  src={"/home3-assets/svgs/services/service-3.png"}
                  className="h-full w-full object-cover"
                  width={520}
                  height={400}
                  alt="Scary robot"
