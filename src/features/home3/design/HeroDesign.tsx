...
import PlusSvg from "../../../../public/home3-assets/svgs/PlusSvg";

export const Gradient = () => {
  return (
    <>
      <div className="relative z-1 mx-2.5 h-6 rounded-b-[1.25rem] bg-[#1B1B2E] shadow-xl lg:mx-8 lg:h-6" />
      <div className="relative z-1 mx-6 h-6 rounded-b-[1.25rem] bg-[#1B1B2E]/70 shadow-xl lg:mx-20 lg:h-6" />
    </>
  );
};
