...
export const mentorsType = defineType({
  name: "mentors",
  title: "Mentors",
  type: "document",
  icon: FiUsers,
  fields: [
    ...
    defineField({
      ...
      description: "Add area of expertise for mentors",
      validation: (Rule) =>
        Rule.required()
          .min(1)
          .error(
    ...
    defineField({
      ...
      description: "Add social media links for the mentor.",
      validation: (Rule) =>
    ...
    defineField({
      ...
      type: "text",
      validation: (Rule) =>
        Rule.required().error("The bio field is required blocks of content."),
    }),
    defineField({
      name: "thoughts",
      title: "Thoughts",
